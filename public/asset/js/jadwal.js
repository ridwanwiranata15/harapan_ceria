...
function OpenEditSchedule(id)
{
    ...
    document.querySelector('.modal-edit-schedule').querySelector('.content').querySelector('table').querySelector('tbody').children[5].children[2].innerText = document.querySelector('table').querySelector('tbody').querySelector('tr[data-id="'+id+'"]').children[6].textContent;
    ...
    document.querySelector('.modal-edit-schedule').querySelector('.content').querySelector('.action-edit').children[0].addEventListener('click', ()=>{
        document.querySelector('.modal-edit-schedule').querySelector('.content').querySelector('form').submit();
        document.querySelector('.modal-edit-schedule').querySelector('.content').querySelector('form').action = id;
    })
